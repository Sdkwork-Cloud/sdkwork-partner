import type { LevelBenefitItem } from '@sdkwork/partner-app-sdk';

/**
 * Display localization for the commercial default level catalog.
 *
 ...
 *
 * App-surface copy (public partner join pages). Keep the data tables in sync
 * with the admin copy in `sdkwork-partner-pc-admin-core/src/catalogLocale.ts`.
 */
const ZH = 'zh-CN';
const EN = 'en-US';
...
export function localizeBenefit(
  benefit: Pick<LevelBenefitItem, 'code' | 'name' | 'value'>,
  language: string,

...
/// Reserved for permission-gated app operations; the current join surface only
/// distinguishes unauthenticated vs. authenticated (no permission scope).
#[allow(dead_code)]
...
pub(crate) fn conflict(context: Option<&WebRequestContext>, detail: impl Into<String>) -> Response {
    problem(
        context,
        StatusCode::CONFLICT,
